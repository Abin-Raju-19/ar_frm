...
const TrainerWorkouts = () => {
  ...
  const handleAssignWorkout = async (e) => {
    ...
    try {
      ...
      setFormError('Failed to assign workout');
    } finally {
      setActionLoading(false);
    }
  };
  ...
  // Filter workouts by type and search query
  const filteredWorkouts = workouts
    ...
    // Only show templates created by this trainer
    .filter(workout => workout.isTemplate && workout.createdBy === currentUser._id);
    ...
    <DashboardLayout>
          ...
          <Card>
            <div className="text-center py-8">
              <p className="text-gray-500 dark:text-gray-400">
                No workout templates found. Create your first template to assign to clients!
              </p>
            </div>
          </Card>
        ) : (
        ...
        <div className="mt-6 flex justify-end space-x-2">
          ...
          <Button 
            onClick={() => {
              ...
              openAssignModal(selectedWorkout);
            }}
          >
            Assign to Client
          </Button>
      ...
      >
        ...
        <form onSubmit={handleAssignWorkout}>
          <div className="mb-4">
            <p className="mb-2">Assigning workout: <strong>{selectedWorkout?.name}</strong></p>
      ...
      >
        ...
        <p className="mb-4">
          Are you sure you want to delete the workout template "{selectedWorkout?.name}"? This action cannot be undone.
        </p>
